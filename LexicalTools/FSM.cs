    ...
    public class FSM
    {
        ...
        private List<State> listStates = new List<State>()
        {
            new State
            {
                ...
                NextStates = new int[] {1, 2, 1, 6, 12, 16, 1, 1, 23, 1,
                                        31, 1, 37, 43, 49, 1, 53, 1,
                                        1, 57, 1, 60, 1,
                                        74, 74, 74, 74, 68, 74, 74, 74, 74,
                                        69, 69, 69, 69, 69, 69, 69, 66, 69, 70, 71,
                                        72, 0, 0, 0, 0, Error_State
                                        }
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{7, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            new State
            {
                DescriptState=7,
            ...
            new State
            {
                ...
                NextStates = new int[]{14, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            new State
            {
                DescriptState=14,
            ...
            new State
            {
                ...
                NextStates = new int[]{17, 19, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            new State
            {
                DescriptState=17,
                ...
                NextStates = new int[]{18, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            new State
            {
                DescriptState=18,
            ...
            new State
            {
                ...
                NextStates = new int[]{21, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{24, 25, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{26, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{27, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{32, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{33, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{34, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{35, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{39, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{41, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{47, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{55, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{61, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{62, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            {
                DescriptState=64,
                InChars=new string[]{"p", "a-o", "r-z", "A-Z", "0-9", ""},

                NextStates = new int[]{65, 1, 1, 1, 1, (int)LexemClass.Identifier}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{67, 76, (int)LexemClass.Operations}
            },
            ...
            new State
            {
                ...
                NextStates = new int[]{75, Error_State, 68}
            },
            new State
            {
                DescriptState=69,
                ...
                NextStates = new int[]{76, (int)LexemClass.Operations}
            },
            new State
            {
                DescriptState=70,
            ...
            new State
            {
                ...
                NextStates = new int[]{72, 73, (int)LexemClass.Literal}
            },
             ...
             new State
            {
                ...
                NextStates = new int[]{73, (int)LexemClass.Literal}
            },
              new State
            {
                DescriptState=74,
